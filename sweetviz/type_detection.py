...
from sweetviz.from_profiling_pandas import (
    is_boolean,
    is_numeric,
    is_categorical,
    could_be_numeric,
...
def determine_feature_type(
    ...
    if (
        ...
        and must_be_this_type != var_type
        and must_be_this_type != FeatureType.TYPE_ALL_NAN
        and var_type != FeatureType.TYPE_ALL_NAN
    ):
        if (
            var_type == FeatureType.TYPE_TEXT
            and must_be_this_type == FeatureType.TYPE_CAT
        ):
            var_type = FeatureType.TYPE_CAT
        elif (
            var_type == FeatureType.TYPE_CAT or var_type == FeatureType.TYPE_BOOL
